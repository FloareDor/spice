...
def extract_txt_features(txt_dir, feat_dir=None, global_flag=True):
    ...
    if feat_dir is None:
        run_command(f'"{sys.executable}" extract_clamp3.py "{txt_dir}" ../cache/txt_features{global_flag}')
    else:
        feat_dir = os.path.abspath(feat_dir)
        run_command(f'"{sys.executable}" extract_clamp3.py "{txt_dir}" "{feat_dir}"{global_flag}')
...
def extract_img_features(img_dir, feat_dir=None, global_flag=True):
    ...
    run_command(f'"{sys.executable}" image_captioning.py "{img_dir}" ../temp/img_captions')
    ...
    if feat_dir is None:
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/img_captions ../cache/img_features{global_flag}')
    else:
        feat_dir = os.path.abspath(feat_dir)
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/img_captions "{feat_dir}"{global_flag}')
...
def extract_xml_features(xml_dir, feat_dir=None, global_flag=True):
    ...
    run_command(f'"{sys.executable}" batch_xml2abc.py "{xml_dir}" ../../temp/std_abc')
    run_command(f'"{sys.executable}" batch_interleaved_abc.py ../../temp/std_abc ../../temp/int_abc')
    ...
    # Step 5: Run extract_clamp3.py
    if feat_dir is None:
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/int_abc ../cache/xml_features{global_flag}')
    else:
        feat_dir = os.path.abspath(feat_dir)
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/int_abc "{feat_dir}"{global_flag}')
...
def extract_mid_features(mid_dir, feat_dir=None, global_flag=True):
    ...
    run_command(f'"{sys.executable}" batch_midi2mtf.py "{mid_dir}" ../../temp/mtf --m3_compatible')
    ...
    # Step 5: Run extract_clamp3.py
    if feat_dir is None:
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/mtf ../cache/mid_features{global_flag}')
    else:
        feat_dir = os.path.abspath(feat_dir)
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/mtf "{feat_dir}"{global_flag}')
...
def extract_audio_features(audio_dir, feat_dir=None, global_flag=True):
    ...
    run_command(f'"{sys.executable}" extract_mert.py --input_path "{audio_dir}" --output_path ../../temp/mert --model_path m-a-p/MERT-v1-95M --mean_features')
    ...
    # Step 5: Run extract_clamp3.py
    if feat_dir is None:
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/mert ../cache/audio_features{global_flag}')
    else:
        feat_dir = os.path.abspath(feat_dir)
        run_command(f'"{sys.executable}" extract_clamp3.py ../temp/mert "{feat_dir}"{global_flag}')
